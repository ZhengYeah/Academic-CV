...
\fancyfoot[C]{\hspace{3.4cm} \thepage\ / \pageref{LastPage}} % Centered page numbers; 3.4cm for letter, 4cm for A4
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\geometry{left=1.4cm, top=1.4cm, right=1.4cm, bottom=2cm} % Suggested margins bottom: 3cm for a4, 2cm for letter
...
\begin{enumerate}[leftmargin=*,labelsep=2mm,start=1]
  \item \textbf{[PETS'26]} \href{https://arxiv.org/pdf/2511.07441}{\textsc{AudAgent}: Automated Auditing of Privacy Policy Compliance in AI~Agents} \\
  \uline{Ye Zheng} and Yidan Hu
  \item \textbf{[PETS'26]}  \href{https://arxiv.org/pdf/2507.02727}{Quantifying Classifier Utility under Local Differential~Privacy} \\
  \uline{Ye Zheng} and Yidan Hu
  \item \textbf{[PETS'26]} \href{https://arxiv.org/pdf/2412.00620}{TraCS: Trajectory Collection in Continuous Space under Local Differential~Privacy} \\
  \uline{Ye Zheng} and Yidan Hu
