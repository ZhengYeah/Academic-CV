...
\section{\textbf{Publications} \textnormal{\scriptsize (1st-author then co-author; full list at \href{https://scholar.google.com/citations?user=XXXX}{Google Scholar})}}
...
\begin{enumerate}[leftmargin=*,labelsep=2mm,start=4]
  ...
  \normalem\emph{\href{https://petsymposium.org/artifact-award.php}{Artifact Award Runner-up}}\ULforem \\
