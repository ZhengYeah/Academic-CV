...
\geometry{left=1.4cm, top=1.6cm, right=1.4cm, bottom=2.8cm}
...
\section{\textbf{Publications} \textnormal{\scriptsize (1st-author then co-author; full list at \href{https://scholar.google.com/citations?hl=en&user=fIwzSr4AAAAJ&view_op=list_works&sortby=pubdate}{Google Scholar})}}
