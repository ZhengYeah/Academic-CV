...
\begin{enumerate}[leftmargin=*,labelsep=2mm,start=1]
  ...
  \uline{Ye Zheng} and Yidan Hu \\
  \normalem {\href{https://petsymposium.org/2026/student-paper-award.php}{\smallicon{\faStar} \textbf{The Andreas Pfitzmann Best Student Paper Award}}} \ULforem
...
\begin{itemize}[leftmargin=0pt,label={}]
  \item \textbf{The Andreas Pfitzmann Best Student Paper Award}, PETS Award Committee \hfill Apr 2026
...
\begin{itemize}[leftmargin=0pt,label={}]
  \item \textbf{Reviewer:} TOIT (2026), TKDD (2025), TASE (2024), SAS (2024)
\end{itemize}
