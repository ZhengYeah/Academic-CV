...
\geometry{left=1.4cm, top=1.2cm, right=1.2cm, bottom=1cm}
...
% Over the past five years, my research has centered around AI for theorem proving, formal privacy, and formal safety.
...
\begin{itemize}[leftmargin=0pt,label={}]
    ...
    \begin{itemize}
      ...
      \item Research Topics: \textbf{AI for Math}, \textbf{Differential Privacy} (Formal Privacy)
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Research Topics: \textbf{Neural Network Verification} (Formal Verification)
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Major: \textbf{Pure Mathematics}
    \end{itemize}
\end{itemize}
