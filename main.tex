...
%---------------- CONFIGURATION ----------------
\definecolor{darkblue}{RGB}{0,0,139} % Color definitions
\pagestyle{fancy} % Page layout
\fancyhf{} % clear all header and footer fields
\fancyfoot[C]{\hspace{3.4cm} \thepage\ / \pageref{LastPage}} % Centered page numbers
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\geometry{left=1.4cm, top=1.4cm, right=1.4cm, bottom=3cm} % Suggested margins bottom: 3cm for a4, 2.2cm for letter
\setlength{\footskip}{1cm} % Space between the bottom of the text and the footer
\usepackage[hidelinks]{hyperref} % Hyperlink setup (moved after fancyhdr to address warning)
...
\newcommand{\smallicon}[1]{\raisebox{0.08em}{\resizebox{!}{0.6em}{#1}}}
% Font options
...
Over the past five years, I have primarily focused on the design and analysis of foundational algorithms for formal privacy and formal safety.
...
\begin{itemize}[leftmargin=0pt,label={}]
    ...
    \begin{itemize}
      ...
      \item Research Interests: AI Privacy, Differential Privacy (Formal Privacy)
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Research Interests: Neural Network Verification (Formal Verification)
    \end{itemize}
...
%   \item \textbf{[Major revision for PETS'26]} \href{https://arxiv.org/pdf/2511.07441}{\textsc{AudAgent}: Automated Auditing of Privacy Policy Compliance in AI~Agents} \\
%   \uline{Ye Zheng} and Yidan Hu
%   \item \textbf{[Major revision for PETS'26]} \href{https://arxiv.org/pdf/2412.00620}{TraCS: Trajectory Collection in Continuous Space under Local Differential~Privacy} \\
%   \uline{Ye Zheng} and Yidan Hu
% \end{enumerate}

{\scriptsize Conference Publications:} 

\begin{enumerate}[leftmargin=*,labelsep=2mm,start=1]
  \item \textbf{[PETS'26]} \href{https://arxiv.org/pdf/2511.07441}
  {\textsc{AudAgent}: Automated Auditing of Privacy Policy Compliance in AI~Agents} \\
  \uline{Ye Zheng}, Yimin Chen, and Yidan Hu
  \item \textbf{[PETS'26]}  \href{https://arxiv.org/pdf/2507.02727}
  {Quantifying Classifier Utility under Local Differential~Privacy} \\
  \uline{Ye Zheng} and Yidan Hu \\
  \normalem {\href{https://petsymposium.org/2026/student-paper-award.php}{\smallicon{\faStar} \textbf{Andreas Pfitzmann Best Student Paper Award}}} \ULforem
  \item \textbf{[PETS'26]} \href{https://arxiv.org/pdf/2412.00620}
  ...
  \normalem {\href{https://petsymposium.org/artifact-award.php}{\smallicon{\faStar} \textbf{Artifact Award Runner-up}}} \ULforem 
  ...
  % ---------------- Co-author papers ----------------
  \item \textbf{[ICDCS'26]} \href{https://arxiv.org/pdf/2508.02551}
  {PrivAR: Client-Side Privacy Framework for Real-Time Location-Based Augmented Reality} \\
  Shafizur Rahman Seeam, \uline{Ye Zheng}, Zhengxiong Li, and Yidan Hu
...
\begin{itemize}[leftmargin=0pt,label={}]
  \item \textbf{Andreas Pfitzmann Best Student Paper Award}, PETS Award Committee \hfill Apr 2026
...
\begin{itemize}[leftmargin=0pt,label={}]
  \item \textbf{Reviewer for:} PETS (2027), TOIT (2026), TKDD (2026, 2025), TASE (2024), SAS (2024)
\end{itemize}
