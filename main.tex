...
\geometry{left=1.4cm, top=1.4cm, right=1.4cm, bottom=2.2cm} % Suggested margins bottom: 3cm for a4, 2.2cm for letter
...
\begin{itemize}[leftmargin=0pt,label={}]
  \item \textbf{Reviewer for:} TOIT (2026), TKDD (2025), TASE (2024), SAS (2024)
\end{itemize}
